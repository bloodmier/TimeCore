...
import { startFortnoxCustomerPolling } from "./workers/fortnoxCustomerPolling.js";
...
import fortnoxRoutes from "./routes/fortnoxRoutes.js";
import fortnoxOAuthRoutes from "./routes/fortnox-oauthRoutes.js";
import worklogPdfRoutes from "./routes/worklogPdfRoutes.js";
import invoiceRoutes from "./routes/invoiceRoutes.js";

dotenv.config();
dotenv.config({
  path: path.resolve(process.cwd(), ".fortnox.env"),
});
const app = express();
...
app.use("/api/fortnox/oauth", fortnoxOAuthRoutes);
app.use("/api/fortnox", requireAuth, requireRole("admin"), fortnoxRoutes);
app.use("/api/worklogpdf", requireAuth, requireRole("admin"), worklogPdfRoutes);
app.use("/api/invoice", requireAuth, requireRole("admin"), invoiceRoutes);
